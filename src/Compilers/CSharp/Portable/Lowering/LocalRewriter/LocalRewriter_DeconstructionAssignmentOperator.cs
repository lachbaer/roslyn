...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed partial class LocalRewriter
    {
            ...
            ArrayBuilder<BoundExpression> effects, ref ArrayBuilder<LocalSymbol> temps)
        {
            ...
            {
                var localSymbol = new SynthesizedLocal(_factory.CurrentMethod, outputPlaceholder.Type, SynthesizedLocalKind.LoweringTemp, Name: "tmp_deconstruct"); //*EIK for test added "tmp_deconstruct"
